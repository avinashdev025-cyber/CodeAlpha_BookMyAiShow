...
echo Please create a new repository named: BookMyAiShow
...
git remote add origin https://github.com/%username%/BookMyAiShow.git
git branch -M main
echo.
...
echo https://github.com/%username%/BookMyAiShow
echo ===================================================
echo.
pause
